...
class _AppointmentListState extends State<AppointmentList> {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            _buildPatientInfoWidget(appointment?['patientId']),
            Text(
  ...
  Widget _buildPatientInfoWidget(String? patientId) {
    return FutureBuilder(
      future: _fetchPatientInfo(patientId),
      builder: (context, patientSnapshot) {
        if (patientSnapshot.connectionState == ConnectionState.waiting) {
          return Text('Loading patient info...');
          ...
          return Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Patient Name: ${patientInfo?['username']}'),
            ],
          );
        }
      },
  ...
  Future<void> _showEditDialog(String? appointmentId) async {
    ...
    if (appointment != null) {
      String newStatus =
          (appointment['status'] == 'in progress') ? 'accepted' : 'in progress';
